	...
	const baseTheme: CustomTheme = {
		...
		palette: {
			...
			background: {
				...
				backgroundImage:
					options?.palette?.background?.backgroundImage || '', // Ensure a default value
			},
		},
		typography: {
			fontFamily:
				options?.typography?.fontFamily || "'Arial', sans-serif", // Default font
...
export const overwatchTheme = createTheme({
	palette: {
		...
		background: {
			...
			backgroundImage:
				'https://i.postimg.cc/prhxrMh8/thumb-1920-553471.jpg',
		},
