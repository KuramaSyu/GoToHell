...
const UserDrawerContents = memo<TopBarProps>(
  ({ userDrawerOpen, handleDrawerOpen, handleDrawerClose }) => {
...
const MobileTopBar = memo<TopBarProps>(
  ({ userDrawerOpen, handleDrawerOpen, handleDrawerClose }) => {
...
const DesktopTopBar = memo<TopBarProps>(
  ({ userDrawerOpen, handleDrawerOpen, handleDrawerClose }) => {
    const navigate = useNavigate();
    const { theme } = useThemeStore();
...
const TopBar: React.FC = () => {
  ...
  // open drawer if URL has profile=true
  useEffect(() => {
  ...
  return isMobile ? <MobileTopBar {...props} /> : <DesktopTopBar {...props} />;
};
